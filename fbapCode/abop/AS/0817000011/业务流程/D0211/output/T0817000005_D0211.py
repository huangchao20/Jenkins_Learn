...
def TD0211_STEP3_NODE8(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = __REQ__["MsgSystemDict"]["RspThirdPath"]+"0817000005/";
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
...
def TD0211_STEP3_NODE13(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __RSP__;
        ACMP_Builtin_LoggerVar(4,"A0","__RSP__");
        _Arg1_ = [["CustBatchRspFile","0817000005"+__REQ__["CurrentDate"]+"_"+__REQ__["CurrentTime"]+".txt.fbaptmp"],["ReadyCustBatchRspFile","01B4"+__REQ__["CurrentDate"]+".TXT"]];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
...
def TD0211_STEP4_NODE6(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = [__REQ__["OneInfo"][5],__REQ__["OneInfo"][6],__REQ__["OneInfo"][7],__REQ__["OneInfo"][8],];
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
        _Arg1_ = "|";
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
...
def TD0211_STEP4_NODE14(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = "select  PRIVATEACCOUNT,  PRIVATEACCOUNTNAME,  ARREARAGEMONEY,  RECORDSTATUS, CHANNELSERIALNO, USERID, CHANNELSERIALNO, ARREARAGESERIALNO, ARREARAGEMONEY from  BPDM_OP_LZGasPayment where "+__REQ__["SysBatchIDList"]+" and RecordStatus = 'S' order by LineNo ASC";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
...
def TD0211_STEP7_NODE5(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
        _Arg3_ = "CustBatchThirdRsp/0817000005/";
        ACMP_Builtin_LoggerVar(4,"A3",_Arg3_);
        _Arg4_ = "0817000005/send/";
...
def TD0211_STEP8_NODE4(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __REQ__["RspResult"]["rspErrCode"]=="AFE_000";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
...
def TD0211_STEP8_NODE7(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __REQ__["RspResult"]["rescode"]=="Y";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
...
def MD0211_ENTRY(__REQ__,__RSP__):
    AFALoggerInfor("开始交易 D0211:水费代扣整合回盘");

    __SND__ = {};
    __RCV__ = {};

    __REQ__["__TRADENAME__"] = "水费代扣整合回盘";
