...
def TD0203_STEP9_NODE7(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = "BPDM_OP_LZGasPayment";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
        _Arg1_ = [  ["CustBatchID",__REQ__["__BODY__"]["CustBatchID"]],  ["SysBatchID",__REQ__["__BODY__"]["SysBatchID"]],  ["CurrentSeries","0"],  ["HostOperSearil","00000000"],  ["HostBatchID","0000000000000000"],  ["LineNo","%09d"%(__REQ__["LineNo"])],  ["ChannelID",__REQ__["ChannelInfo"][0][0]],  ["Channelserialno",__REQ__["CurrentDate"]+__REQ__["Channelserialno"]],  ["CreateDate",__REQ__["ChannelInfo"][0][2]],  ["Brno",__REQ__["__BODY__"]["BranchID"]],  ["Tellerno",__REQ__["InDoorAcctInfo"][0][3]],  ["PrivateAccount",__REQ__["PersonAgreementInfo"][0][0]],  ["PrivateAccountName",__REQ__["PersonAgreementInfo"][0][1]],  ["InterimAccount",__REQ__["InDoorAcctInfo"][0][0]],  ["InterimAccountName",__REQ__["InDoorAcctInfo"][0][1]],  ["CurrencyType","01"],  ["RecordStatus","D"],  ["ErrorCode","0000"],  ["ErrorMsg",""],  ["NearOperateDate",__REQ__["CurrentDate"]],  ["UserID",__REQ__["TMPList"][0]],  ["CompanyCode","00"],  ["ARREARAGESERIALNO",__REQ__["TMPList"][1]],  ["ArrearageMoney",__REQ__["TMPList"][2]],  ["StatusCode","0"],];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = False;
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
...
def TD0203_STEP9_NODE13(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg1_ = "Money";
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = "%.2f"%(float(__REQ__["Money"])+float(__REQ__["TMPList"][2]));
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
...
def TD0203_STEP9_NODE17(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = "select  accno, accname from afa_memy_protocolinfo  where   productcode=?  and  productmaincode=? and  signinfo=? and protocolstatus=? and  clienttype = ?";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
        _Arg1_ = [__REQ__["__BODY__"]["AppID"],__REQ__["__BODY__"]["AppType"],__REQ__["TMPList"][0],"A2","1"];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = 0;
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
...
def TD0203_STEP9_NODE20(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = "select   BankIndoorAcct,  BankIndoorAcctName,  VMChannelID,  VMTelleter from ABOP_AppBatchIndoorAcctInfo where   BankAccType=? and  AppType=? and  AppID=? and BranchID=?";
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
        _Arg1_ = ["1",__REQ__["__BODY__"]["AppType"],__REQ__["__BODY__"]["AppID"],__REQ__["__BODY__"]["BranchID"]];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = 0;
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
...
def MD0203_ENTRY(__REQ__,__RSP__):
    AFALoggerInfor("开始交易 D0203:水费代扣文件入库");

    __SND__ = {};
    __RCV__ = {};

    __REQ__["__TRADENAME__"] = "水费代扣文件入库";
