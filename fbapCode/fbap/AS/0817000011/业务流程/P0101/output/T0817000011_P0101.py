...
def TP0101_STEP8_NODE4(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __REQ__;
        ACMP_Builtin_LoggerVar(4,"A0","__REQ__");
        _Arg1_ = [  ["BankAccountName",__REQ__.get("BankAccountName","")],  ["SignBegDate",__REQ__["newdate"]],  ["SignEndDate","2099-12-30"],];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = None;
        ACMP_Builtin_LoggerVar(4, "A2", None);
        _Arg3_ = None;
...
def TP0101_STEP8_NODE7(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        __BUILTIN__ = {};
        __BUILTIN__["SchoolCode"] = deepcopy(__REQ__["enterprotocolno"]);
        ...
        __BUILTIN__["CustomerName"] = deepcopy(__REQ__["CustomerName"]);
        ACMP_Builtin_LoggerVar(4,'A2:__BUILTIN__["CustomerName"]',__BUILTIN__["CustomerName"]);
        __BUILTIN__["BankAccountNo"] = deepcopy(__REQ__["BankAccountNo"]);
        ACMP_Builtin_LoggerVar(4,'A3:__BUILTIN__["BankAccountNo"]',__BUILTIN__["BankAccountNo"]);
        __BUILTIN__["BankAccountName"] = deepcopy(__REQ__["BankAccountName"]);
        ACMP_Builtin_LoggerVar(4,'A4:__BUILTIN__["BankAccountName"]',__BUILTIN__["BankAccountName"]);
        __BUILTIN__["SignBegDate"] = deepcopy(__REQ__["SignBegDate"]);
        ACMP_Builtin_LoggerVar(4,'A5:__BUILTIN__["SignBegDate"]',__BUILTIN__["SignBegDate"]);
        __BUILTIN__["SignEndDate"] = deepcopy(__REQ__["SignEndDate"]);
        ACMP_Builtin_LoggerVar(4,'A6:__BUILTIN__["SignEndDate"]',__BUILTIN__["SignEndDate"]);
...
def TP0101_STEP8_NODE12(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __REQ__;
        ACMP_Builtin_LoggerVar(4,"A0","__REQ__");
        _Arg1_ = [["thirdstatus" , "F"],["thirddealcode" , "FBAP01"],["thirddealmsg" ,"用户编号长度错误，请输入18位身份证号码！"],];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = None;
        ACMP_Builtin_LoggerVar(4, "A2", None);
        _Arg3_ = None;
