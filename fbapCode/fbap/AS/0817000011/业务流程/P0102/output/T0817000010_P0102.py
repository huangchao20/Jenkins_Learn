...
def TP0102_STEP11_NODE7(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        ACMP_Builtin_LoggerVar(4,'A3:__BUILTIN__["CustomerNo"]',__BUILTIN__["CustomerNo"]);
...
def TP0102_STEP11_NODE14(__REQ__,__RSP__,__SND__,__RCV__):
    try:
        ...
        _Arg0_ = __REQ__["productcode"];
        ACMP_Builtin_LoggerVar(4,"A0",_Arg0_);
        _Arg1_ = __REQ__["thirddealcode"];
        ACMP_Builtin_LoggerVar(4,"A1",_Arg1_);
        _Arg2_ = __REQ__["thirddealmsg"];
        ACMP_Builtin_LoggerVar(4,"A2",_Arg2_);
        _Arg3_ = "FBAP";
        ACMP_Builtin_LoggerVar(4,"A3",_Arg3_);
        _Arg4_ = None;
        ...
        _Result_ = P_ErrCode_P_ErrCode_Map(_Arg0_,_Arg1_,_Arg2_,_Arg3_,_Arg4_,_Arg5_);

        if((_Result_[1] == None) and (_Result_[2] == None)):
            _RTVAL_ = _Result_[3];

            __REQ__["dealcode"] = _RTVAL_[0];
            ACMP_Builtin_LoggerVar(4,"O0",__REQ__["dealcode"]);
            __REQ__["dealmsg"] = _RTVAL_[1];
            ACMP_Builtin_LoggerVar(4,"O1",__REQ__["dealmsg"]);
        else:
            ACMP_Builtin_SetGlobalError("D",str(_Result_[1]),str(_Result_[2]));
