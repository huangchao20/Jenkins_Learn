...
class c_step4_get_email:
    ...
    def get_att(msg_in, str_day_in):
        ...
        for part in msg_in.walk():
            ...
            if file_name:
                ...
                att_file = open('C:\\Users\\huang\\Downloads' + filename, 'wb')
    ...
    @staticmethod
    def run_ing(email_user, password):
        # 输入邮件地址, 口令和POP3服务器地址:
        # email_user = '******@163.com'
        ...
        # str_day = '{0}{1}{2}'.format(tm[0], tm[1], tm[2])
        print(str_day)
        # 连接到POP3服务器,有些邮箱服务器需要ssl加密，可以使用poplib.POP3_SSL
        try:
            telnetlib.Telnet('pop.126.com', 995)
...
if __name__ == '__main__':
    ...
    origin = sys.stdout
    f = open('G:\\黄大宝python\\测试目录\\log.txt', 'w')
    email_user = input('邮箱:')
    password = input('密码:')
    sys.stdout = f
    try:
        c_step4_get_email.run_ing(email_user, password)
